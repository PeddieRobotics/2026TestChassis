...
public class Right3MidOrbitAuto {
    public static final Command auto = new SequentialCommandGroup(
        ...
        new AutoDriveCommand(
            ...
            new GoalEndState(TrenchAlignConstants.kStage1Speed, Rotation2d.fromDegrees(0.89))
        ),
        ...
        new AutoDriveCommand(
            List.of(
                ...
                new Pose2d(
                    7.384, FieldConstants.kFieldSize.getY() - 5.612,
                    Rotation2d.fromDegrees(113.629)
                )
            ),
            List.of(
